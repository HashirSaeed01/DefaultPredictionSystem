...
def login():
    ...
    if 'login' in request.form:
        ...
        # Check the password and user existence
...
# @blueprint.route('/index')
# def index():
#     return render_template('home/index.html')  # This links to templates/home/index.html
...
def user():
    return render_template('home/user.html')  # Th


@blueprint.route('/tables')
def tables():
    return render_template('home/tables.html')  # Th
